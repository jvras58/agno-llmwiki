...
class Settings(BaseSettings):
    ...
    vault_path: str = Field(
        ...,
        alias="vault_internal_path",
        description="Caminho absoluto para os arquivos Markdown locais",
    )

    # Configurações do Banco de Dados
    db_url_vectordb: str = Field(
        default="postgresql+psycopg://user:pass@localhost:5432/vectordb",
    ...
    embedder_model: str = Field(
        ...
        description="Modelo de embedder a ser utilizado",
    )
